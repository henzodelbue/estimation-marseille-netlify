      ...
      <div className="relative z-10">
        ...
        <section className="pt-16 pb-12 px-6">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 backdrop-blur-xl bg-white/70 border border-gold-light/40 rounded-full mb-6">
              ...
              <span className="text-sm font-bold text-primary">Agent Immobilier Professionnel</span>
            </div>
            ...
            <p className="text-lg text-text-gray max-w-2xl mx-auto">
              Agent immobilier chez Llinares Immobilier, je vous accompagne dans tous vos projets immobiliers avec sérieux et professionnalisme.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-6">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              {/* Photo placeholder */}
              <div className="backdrop-blur-2xl bg-white/80 border border-gold-light/40 rounded-3xl p-8 shadow-2xl text-center">
                <div className="w-48 h-48 mx-auto bg-gradient-to-br from-gold/20 to-gold-light/20 rounded-full flex items-center justify-center mb-6 border-4 border-gold/30">
                  <Users className="text-gold" size={80} />
                </div>
                <h2 className="text-2xl font-bold text-primary mb-2">Henzo DEL BUE</h2>
                <p className="text-gold font-medium mb-4">Agent Immobilier</p>
              ...
              <div className="space-y-6">
                <div className="backdrop-blur-xl bg-white/70 border border-gold-light/40 rounded-2xl p-6 hover:bg-white/80 transition-all">
                  <div className="flex items-start gap-4">
                    <div className="p-3 bg-gold/10 rounded-xl">
                      <Shield className="text-gold" size={24} />
                    </div>
                    <div>
                      <h3 className="font-bold text-primary text-lg mb-2">Expertise locale</h3>
                      <p className="text-text-gray">Une connaissance approfondie du marché immobilier marseillais et de ses 111 quartiers.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="backdrop-blur-xl bg-white/70 border border-gold-light/40 rounded-2xl p-6 hover:bg-white/80 transition-all">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-primary text-lg mb-2">Accompagnement personnalisé</h3>
                      <p className="text-text-gray">Un suivi sur-mesure de votre projet, de l'estimation à la signature.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="backdrop-blur-xl bg-white/70 border border-gold-light/40 rounded-2xl p-6 hover:bg-white/80 transition-all">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-primary text-lg mb-2">Professionnalisme</h3>
                      <p className="text-text-gray">Un engagement total pour la réussite de votre transaction immobilière.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-12 px-6">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-text-gray">Un accompagnement complet pour vos projets immobiliers</p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="backdrop-blur-xl bg-white/70 border border-gold-light/40 rounded-2xl p-6 hover:bg-white/80 hover:scale-[1.02] transition-all">
        ...
        <section className="py-12 px-6">
          <div className="max-w-3xl mx-auto">
            <div className="backdrop-blur-2xl bg-white/80 border border-gold-light/40 rounded-3xl p-8 md:p-12 shadow-2xl text-center">
              <h2 className="text-2xl md:text-3xl font-black mb-4">
                <span className="bg-gradient-to-r from-primary to-primary bg-clip-text text-transparent">Contactez-moi</span>
              </h2>
              <p className="text-text-gray mb-8">Discutons de votre projet immobilier</p>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                <a href="tel:+33782402998" className="flex items-center gap-3 px-6 py-3 backdrop-blur-xl bg-white/70 border border-gold-light/40 rounded-xl hover:bg-gold/10 transition-all">
                  <Phone className="text-gold" size={20} />
                  <span className="font-medium text-primary">07 82 40 29 98</span>
                </a>
                <a href="mailto:henzodelbue@gmail.com" className="flex items-center gap-3 px-6 py-3 backdrop-blur-xl bg-white/70 border border-gold-light/40 rounded-xl hover:bg-gold/10 transition-all">
                  <Mail className="text-gold" size={20} />
                  <span className="font-medium text-primary">henzodelbue@gmail.com</span>
                </a>
              </div>

              <div className="flex items-center justify-center gap-2 text-text-gray mb-8">
                <MapPin className="text-gold" size={18} />
                <span>Marseille et alentours</span>
              </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-gold to-gold text-white rounded-2xl font-bold hover:shadow-2xl hover:scale-105 transition-all shadow-xl shadow-gold/30"
              >
                Prendre rendez-vous
              </a>
            </div>
        ...
        <footer className="border-t border-gold-light/40 backdrop-blur-xl bg-white/70 py-8 px-6">
          <div className="max-w-7xl mx-auto text-center">
            <p className="text-sm text-text-gray">&copy; 2025 Estimation Immobilière Marseille • Henzo DEL BUE • Llinares Immobilier</p>
          </div>
        </footer>
      </div>
    </div>
